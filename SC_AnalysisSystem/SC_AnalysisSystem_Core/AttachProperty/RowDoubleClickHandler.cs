...
namespace SC_AnalysisSystem_Core.AttachProperty
{
    public sealed class RowDoubleClickHandler : FrameworkElement
    {
        public RowDoubleClickHandler(DataGrid dataGrid)
        {
            ...
            dataGrid.LoadingRow += (s, e) => e.Row.MouseDoubleClick += handler;
            dataGrid.UnloadingRow += (s, e) => e.Row.MouseDoubleClick -= handler;
        }
        ...
        public static readonly DependencyProperty MethodNameProperty = DependencyProperty.RegisterAttached("MethodName", typeof(string), typeof(RowDoubleClickHandler),
